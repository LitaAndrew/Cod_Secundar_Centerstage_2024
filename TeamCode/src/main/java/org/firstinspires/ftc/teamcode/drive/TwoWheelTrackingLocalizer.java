...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = -6.89; // X is the up and down direction
    public static double PARALLEL_Y = 0; // Y is the strafe direction

    public static double PERPENDICULAR_X = 0;
    public static double PERPENDICULAR_Y = 0;

    public static double X_MULTIPLIER = 0.9814612868; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 0.9793253536; // Multiplier in the Y direction
